...
本项目已发布到npm，支持通过HTTP或Server-Sent Events (SSE) 方式进行云端部署。
...
- **开发调试**: 推荐使用本地部署，便于修改和调试
- **生产环境**: 推荐使用HTTP/SSE部署，享受云端服务的稳定性
- **离线环境**: 必须使用本地部署
- **快速体验**: 推荐使用npm包部署，平衡了便利性和性能
